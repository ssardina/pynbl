...
class Game:
    ...
    def _extract_stints_stats_df(self) -> dict:
        ...
        stint_stats1_df = build_stats_df(self.pbp_df, 1, "stint1") # full stats for team 1
        stint_stats2_df = build_stats_df(self.pbp_df, 2, "stint2") # full stats for team 2
...
class PBP:
    def __init__(self, game_json, game_id) -> None:
